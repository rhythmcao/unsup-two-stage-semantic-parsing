...
def main(args=sys.argv[1:]):
    ...
    all_dataset = [args.dataset] if args.dataset in DOMAINS else DOMAINS
    dirname = os.path.join('data', 'geo') if args.dataset == 'geo' else os.path.join('data', 'overnight')
    for dataset in all_dataset:
        ...
        _, id2nl = construct_vocab(nl, mwf=args.mwf)
        _, id2lf = construct_vocab(lf, mwf=args.mwf)
        _, id2cf = construct_vocab(cf, mwf=args.mwf)
