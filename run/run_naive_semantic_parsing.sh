...
python3 scripts/naive_semantic_parsing.py --task $task --emb_size $emb_size --hidden_dim $hidden_dim --num_layers $num_layers \
    ...
    --labeled $labeled --deviceId $deviceId --seed $seed # --nl_vocab
