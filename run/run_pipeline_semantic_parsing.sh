...
task='pipeline_semantic_parsing'
dataset=$1
...
python3 scripts/pipeline_semantic_parsing.py --task $task --emb_size $emb_size --hidden_dim $hidden_dim --num_layers $num_layers \
    ...
    --read_nsp_model_path $read_nsp_model_path --labeled $labeled --deviceId $deviceId --seed $seed
