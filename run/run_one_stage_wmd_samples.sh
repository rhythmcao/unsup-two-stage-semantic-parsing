...
python3 scripts/one_stage_wmd_samples.py --task $task --dataset $dataset --embed_size $embed_size --hidden_size $hidden_size \
    ...
    --beam_size $beam_size --n_best $n_best --deviceId $deviceId --seed $seed
