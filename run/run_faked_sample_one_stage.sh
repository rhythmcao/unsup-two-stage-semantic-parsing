...
task=faked_sample_one_stage_${2}
dataset=$1
# read_model_path=''
...
python3 scripts/faked_sample_one_stage.py --task $task --emb_size $emb_size --hidden_dim $hidden_dim --num_layers $num_layers \
    ...
    --labeled $labeled --deviceId $deviceId --seed $seed --method $method
