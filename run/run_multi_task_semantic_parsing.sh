...
task='multi_task_semantic_parsing'
dataset=$1
# read_model_path=''
...
python3 scripts/multi_task_semantic_parsing.py --task $task --emb_size $emb_size --hidden_dim $hidden_dim --num_layers $num_layers \
